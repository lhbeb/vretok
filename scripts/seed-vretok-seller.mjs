...
const reviews = [
  ...
  },
  {
    ...
    rating: 5,
    date: '2026-08-02',
    title: 'I get compliments every time',
    content: 'Obsessed with the grey shorts and leggings, I get compliments every time I wear them.',
    helpful: 0,
    verified: true,
  },
  {
    ...
    rating: 5,
    date: '2026-07-21',
    title: "I wouldn't hesitate to order again",
    content: "I'm super happy. The quality is incredible, I have no regrets, and I wouldn't hesitate to order again.",
    helpful: 0,
    verified: true,
  },
  {
