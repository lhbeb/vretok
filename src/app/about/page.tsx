  ...
  return (
    <main className="min-h-screen bg-[#F7F3E8]/40">
      ...
      <section className="mx-auto max-w-4xl space-y-10 px-6 py-16">
        <div><h2 className="mb-4 text-3xl font-bold text-[#123E52]">Activewear Made to Move</h2><p className="leading-8 text-gray-700">Choose pieces by fit, fabric, support, rise, and intended activity. Every product page gives you the details you need to build a training wardrobe that feels as strong as it looks.</p></div>
        <div className="rounded-2xl bg-white p-8 shadow-sm"><h2 className="mb-4 text-2xl font-bold text-[#123E52]">Explore the Collection</h2><p className="mb-6 leading-8 text-gray-700">Discover Vretok leggings, matching sets, gym tops, and activewear accessories designed to work together.</p><Link className="font-semibold text-[#123E52] underline" href="/search">Browse the collection →</Link></div>
        <div><h2 className="mb-4 text-2xl font-bold text-[#123E52]">Here to Help</h2><p className="mb-4 leading-8 text-gray-700">Have a question about a product or an order? Get in touch with our team.</p><Link className="font-semibold text-[#123E52] underline" href="/contact">Contact Vretok →</Link></div>
      </section>
    </main>
  );
}
