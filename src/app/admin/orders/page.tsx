    ...
    >
      ...
      <div className="mb-4 flex justify-end">
        <button
          ...
          className="inline-flex items-center gap-2 px-4 py-2 bg-[#0F172A] text-white rounded-lg hover:bg-[#020617] transition-colors"
        >
          ...
          <div className="bg-white rounded-2xl shadow-xl max-w-md w-full p-6">
            ...
            <div className="space-y-3 mb-6">
              ...
              <button
                ...
                className="w-full text-left p-4 border-2 border-[#0F172A]/20 bg-[#0F172A]/5 rounded-xl hover:bg-[#0F172A]/10 hover:border-[#0F172A]/30 transition-colors"
              >
                <div className="flex items-center justify-between">
                  <div>
                  ...
                  <Package className="h-6 w-6 text-[#0F172A] flex-shrink-0" />
                </div>
              </button>
            </div>
              ...
              >
                ...
                >
                  <div className="flex items-center gap-4">
                    ...
                    {/* Customer Avatar */}
                    <div className="h-10 w-10 bg-gradient-to-br from-[#0F172A] to-purple-600 rounded-full flex items-center justify-center text-white font-semibold text-sm flex-shrink-0">
                      ...
                      <div className="space-y-2">
                        <div className="flex items-center gap-2">
                          ...
                          <Link
                            ...
                            rel="noopener noreferrer"
                            onClick={(e) => e.stopPropagation()}
                            className="inline-flex items-center gap-1 px-2 py-1 text-xs font-medium text-[#0F172A] hover:text-[#020617] hover:bg-[#0F172A]/5 rounded-lg transition-colors"
                            title="View product"
                          >
                  ...
                  <div className="mt-4 pt-4 border-t border-gray-100 flex flex-wrap gap-2">
                    ...
                    {!order.email_sent && (
                      <button
                        ...
                        className="inline-flex items-center gap-2 px-3 py-2 bg-[#0F172A]/10 text-[#0F172A] rounded-lg text-sm font-medium hover:bg-[#0F172A]/15 disabled:opacity-50 transition-all"
                      >
