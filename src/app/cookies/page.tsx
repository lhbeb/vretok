    ...
    <main className="min-h-screen bg-gray-50 py-12">
      <div className="container mx-auto max-w-4xl px-4">
        ...
        <section className="mt-8 space-y-8 rounded-3xl border bg-white p-7 text-gray-700 sm:p-10">
          ...
          <div><h2 className="text-2xl font-bold text-[#123E52]">Optional analytics</h2><p className="mt-3 leading-7">If you select Accept, optional analytics may measure visits, pages viewed, device details, and shopping events so we can understand and improve the store. Vretok currently uses Vercel Speed Insights and may use configured site or advertising analytics. Optional analytics is not loaded after you select Decline.</p></div>
