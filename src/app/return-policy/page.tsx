    ...
    <main className="min-h-screen bg-gray-50 py-12">
      <div className="container mx-auto max-w-4xl px-4">
        ...
        <section className="mt-8 space-y-8 rounded-3xl border bg-white p-7 text-gray-700 sm:p-10">
          ...
          <div><h2 className="text-2xl font-bold text-[#0F172A]">Change-of-mind returns</h2><p className="mt-3 leading-7">For an eligible change-of-mind return, the customer is responsible for return shipping. Original shipping upgrades, if any, are not refundable. No restocking fee is charged when the item is returned in the required condition.</p></div>
