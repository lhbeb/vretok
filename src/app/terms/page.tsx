    ...
    <main className="min-h-screen bg-gray-50 py-12">
      <div className="container mx-auto max-w-4xl px-4">
        ...
        <section className="mt-8 space-y-8 rounded-3xl border bg-white p-7 text-gray-700 sm:p-10">
          ...
          <div><h2 className="text-2xl font-bold text-[#0F172A]">3. Prices and payment</h2><p className="mt-3 leading-7">Prices are displayed in British pounds (GBP). The order summary shows the product total, the £29.99 GBP standard worldwide shipping charge, and the complete amount before payment. Payment is processed through the secure payment option presented during checkout. Do not send payment outside the checkout instructions shown for your order.</p></div>
          <div><h2 className="text-2xl font-bold text-[#0F172A]">4. Shipping</h2><p className="mt-3 leading-7">We offer standard worldwide shipping for £29.99 GBP per order. Handling time, transit estimates, address requirements, and tracking information are stated in our <Link href="/shipping-policy" className="font-semibold text-[#0F172A] underline">Shipping Policy</Link>. Delivery dates are estimates unless expressly stated otherwise.</p></div>
