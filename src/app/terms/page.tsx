    ...
    <main className="min-h-screen bg-gray-50 py-12">
      <div className="container mx-auto max-w-4xl px-4">
        ...
        <section className="mt-8 space-y-8 rounded-3xl border bg-white p-7 text-gray-700 sm:p-10">
          ...
          <div><h2 className="text-2xl font-bold text-[#123E52]">8. Liability</h2><p className="mt-3 leading-7">Nothing in these terms limits rights that cannot lawfully be limited. To the extent permitted by law, Vretok is not responsible for indirect or consequential loss arising from use of the website or products.</p></div>
