        ...
        <div className="px-5 py-5 sm:px-6">
          <div className="flex items-start gap-3">
            ...
            <div className="min-w-0">
              ...
              <p className="mt-1 text-sm text-[#E11D48] font-medium">{market.freeShippingText}</p>
            </div>
          </div>
        </div>
        ...
        <div className="px-5 py-5 sm:px-6">
          <div className="flex items-start gap-3">
            ...
            <div className="min-w-0">
              ...
              <p className="mt-1 text-sm text-[#E11D48] font-medium">Eligible returns within 30 days</p>
            </div>
          </div>
        </div>
      </div>
